...
#     'CA': {1: {
#     'FOODS': {  
#                 1 : [ num for num in list(1, 220) if num not in [7, 100, 165]],
#                 2: [ num for num in list(1, 400 ) if num not in [98]],
#                 3: [ num for num in list(1, 828) if num not in [52, 699, 728, 740]]
#             },
